...
public class Level4Provider extends WorldProvider
{
	@Override
	public DimensionType getDimensionType() {
		return DimensionInit.LEVEL4;
	}

	@Override
	public IChunkGenerator createChunkGenerator() {
		return new Level4ChunkGenerator(this.world, "level4/", OriginalContexts.EMPTY_FILLER, true);
	}
	...
	protected void init() {
		...
		this.biomeProvider = (BiomeProvider)new BiomeProviderSingle(BiomeInit.LEVEL4KEY);
	}
