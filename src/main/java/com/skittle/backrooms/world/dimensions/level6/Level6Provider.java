...
public class Level6Provider extends WorldProvider
{
	@Override
	public DimensionType getDimensionType() {
		return DimensionInit.LEVEL6;
	}
	...
	protected void init() {
		...
		this.biomeProvider = (BiomeProvider)new BiomeProviderSingle(BiomeInit.LEVEL6KEY);
	}
