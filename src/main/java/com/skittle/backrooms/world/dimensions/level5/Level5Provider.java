...
public class Level5Provider extends WorldProvider
{
	@Override
	public DimensionType getDimensionType() {
		return DimensionInit.LEVEL5;
	}

	@Override
	public IChunkGenerator createChunkGenerator() {
		return new Level5ChunkGenerator(this.world, "level5/", OriginalContexts.LEVEL5_DIMENSION, false);
	}
	...
	protected void init() {
		...
		this.biomeProvider = (BiomeProvider)new BiomeProviderSingle(BiomeInit.LEVEL5KEY);
	}
