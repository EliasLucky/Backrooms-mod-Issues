...
public class BackroomsDimensionalDoor extends Block
{
	private final DoorType doorType;
	
	public BackroomsDimensionalDoor(String name, Material material, SoundType soundType, DoorType doorType, float hardness, float resistance, boolean isLightEnabled)
	{
		super(material);
...
//	public BackroomsDimensionalDoor(String name, Material material, SoundType soundType, float hardness, float resistance, int lightValue)
//	{
//		super(material);
//		
//		setUnlocalizedName(name);
