...
public class AntiqueWallLight extends DirectionalHorizontalWallBlock
{
	public AntiqueWallLight(String name, Material material, SoundType soundType, float hardness, float resistance, int lightVal) {
		super(material);
